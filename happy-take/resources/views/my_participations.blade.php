        ...
        <div class="row">
            <div class="col-lg-3 g-mb-50 g-mb-0--lg">
                ...
                <div class="list-group list-group-border-0 g-mb-40">
                    ...
                    <a href="{{ url('/my_participations') }}" class="list-group-item justify-content-between active">
                        ...
                        <article class="g-brd-around g-brd-gray-light-v4 rounded">
                            <div class="g-pa-30">
                                <h3 class="g-font-weight-300 g-mb-15">
                                    <a class="u-link-v5 g-color-main g-color-primary--hover" href="{{ url('/participation/'.$participation -> id) }}">{{ $participation -> post -> from }} <i class="fa fa-arrow-right" aria-hidden="true"></i> {{ $participation -> post -> to }}</a>
                                </h3>
                                <p><!--導航資訊--></p>
                            </div>
                            <div class="media g-font-size-12 g-brd-top g-brd-gray-light-v4 g-pa-15-30">
                                <div class="media-body align-self-center">
                                    ...
                                    <span class="u-link-v5 g-color-main g-color-primary--hover">{{ $participation -> post -> date }}</span>
                                </div>
                                <div class="align-self-center">
                                    <span class="u-link-v5 g-color-main g-color-primary--hover g-mr-10">
                                        <i class="fa fa-user g-ml-7"></i>
                                        {{ $participation -> count() }} / {{ $participation -> post -> number }}
                                    </span>
                                    <span class="u-link-v5 g-color-main g-color-primary--hover">
                                        <i class="fa fa-star g-ml-7"></i>
                                        {{ $participation -> post -> comments != '[]' ? round($participation -> post -> comments -> avg('score'), 1) : 0 }}
                                    </span>
                                </div>
                            </div>
                        </article>
